...
public class ImageController {
   ...
   */
  @RequestMapping(value = "/{path}/{id}", method = RequestMethod.GET, produces = MediaType.IMAGE_JPEG_VALUE)
   ...
   * @return Une réponse HTTP renvoyant un status code à 201 (correspondant à
   *         'CREATED') indiquant que la requete à créé un nouvelle ressource et
